...
> Mata aldrig ut facit i förväg. Avsluta inte direkt vid diagnos — spela igenom fallets hårdkodade tail-eskaleringar tills fallet är slut.
...
## 5. TAIL — BEGRÄNSADE ESKALERINGAR
Vid feedback: kör fallets `tail`. Spela `escalations[]` en i taget (ny försämring/komplikation → nytt beslut).
När de tar slut visas "Fallet är slut". Eskaleringar är hårdkodade (oftast 1-3 stycken per fall); generera inte nya i oändlighet. Crosslinking till nya entiteter är framtida arbete.
